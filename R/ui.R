    ...
    shiny::fluidPage(
      ...
      shiny::tabsetPanel(
        shiny::tabPanel(
          ...
          shinyBS::bsCollapse(
            id = "clpMain",
            open = c("folders", "merge", "omit traits", "reduce traits by clustering", "HeatMap"),
            multiple = TRUE,
            ...
            shinyBS::bsCollapsePanel(
              ...
              shiny::actionButton("btnReduce", label = "Step 3: Reduce data (omit CpGs) by p-value, DM or n limit"),
            ...
            shinyBS::bsCollapsePanel(
              ...
              shiny::actionButton("btnOmitTraits", label = "Step 4: Omit Traits"),
              ...
              shiny::fluidRow(
                ...
                # shiny::actionButton("btnCluster", label = "Step 5: Cluster & reduce trait data"),
                ...
                shiny::tabsetPanel(
                  shiny::tabPanel(
                    ...
                    shiny::tabsetPanel(
                      shiny::tabPanel(
                        "HeatMap P_Val",
                        shiny::actionButton("btnPlotCombinedHM_P_Val", label = "Step 5: Plot Heatmap P_Val"),
                        shiny::verbatimTextOutput("txtHMDescription_P_Val", placeholder = TRUE),
                        shiny::column(
                          width = 6,
                          shiny::numericInput(inputId = "numHMHSize", label = "Width", value = 4000, min = 1000, max = 10000),
                        ),
                        shiny::column(
                          width = 6,
                          shiny::numericInput(inputId = "numHMVSize", label = "Height", value = 4000, min = 1000, max = 10000),
                        ),
                        InteractiveComplexHeatmap::InteractiveComplexHeatmapOutput(
                          ...
                          width2 = 4000,
                          inline = FALSE,
#                          output_ui = shiny::htmlOutput("info_HM_P_Val")
                        )
                      ),
                      shiny::tabPanel(
                      ...
                      shiny::tabPanel(
                        "Distance weighted HeatMap P_Val",
                        shiny::tabsetPanel(
                          shiny::tabPanel(
                            "condensed (contain sonly CpG wih nearby neighbours)",
                            ...
                            shiny::column(
                              width = 6,
                              shiny::numericInput(inputId = "numCondDWHMHSize", label = "Width", value = 4000, min = 1000, max = 10000),
                            ),
                            shiny::column(
                              width = 6,
                              shiny::numericInput(inputId = "numCondDWHMVSize", label = "Height", value = 4000, min = 1000, max = 10000),
                            ),
                            InteractiveComplexHeatmap::InteractiveComplexHeatmapOutput(
                              "condDWHeatmap_P_Val",
                              height1 = 4000,
                              ...
                              width2 = 4000,
                              inline = FALSE,
#                              output_ui = shiny::htmlOutput("info_CondDWHM_P_Val")
                            )
                          ),
                          shiny::tabPanel(
                            "full",
                            ...
                            shiny::column(
                              width = 6,
                              shiny::numericInput(inputId = "numDWHMHSize", label = "Width", value = 4000, min = 1000, max = 10000),
                            ),
                            shiny::column(
                              width = 6,
                              shiny::numericInput(inputId = "numDWHMVSize", label = "Height", value = 4000, min = 1000, max = 10000),
                            ),
                            InteractiveComplexHeatmap::InteractiveComplexHeatmapOutput(
                              "DWHeatmap_P_Val",
                              height1 = 4000,
                              ...
                              width2 = 4000,
                              inline = FALSE,
#                              output_ui = shiny::htmlOutput("info_DWHM_P_Val")
                            )
                          )
                        )
                      ),
                  ...
                  # shiny::tabPanel(
                  #   "Histogram on Delta Methylation",
                  #   shiny::verbatimTextOutput("txtDMTraits", placeholder = TRUE),
                  #   plotly::plotlyOutput("histDM", inline = TRUE)
                  # ),
                  # shiny::tabPanel(
                  #   "Heatmap Delta Methylation",
                  #   shiny::actionButton("btnPlotCombinedHM_DM", label = "Step 5: Plot Heatmap DM"),
                  #   shiny::verbatimTextOutput("txtHMDescription_DM", placeholder = TRUE),
                  #   InteractiveComplexHeatmap::InteractiveComplexHeatmapOutput(
                  #     "Heatmap_DM",
                  #     height1 = 2000,
                  #     width1 = 1500,
                  ...
                  #     width2 = 1500,
                  #     inline = FALSE,
                  #     output_ui = shiny::htmlOutput("info_HM_DM")
                  #   )
                  # ),
                  shiny::tabPanel(
