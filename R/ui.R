...
#                shiny::textInput("txtP_VALborder", "P_VAL Border 5*10^-", 18, placeholder = TRUE),
    ...
    #              column(width = 12, plotly::plotlyOutput("plotDendrogramTraits"))
                ...
                shiny::tabPanel("Pairwise Distances Traits",
                                DT::dataTableOutput("DTPairwiseDistTraits")
                ),
                shiny::tabPanel("Different Ordered Distances Traits",
                        DT::dataTableOutput("DTDifferentOrderedDistMatTraits")
                ),
                shiny::tabPanel("Pairwise Distances Probes",
                                DT::dataTableOutput("DTPairwiseDistProbes")
                )
            )
          )
        ),
